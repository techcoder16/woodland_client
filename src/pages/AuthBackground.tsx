...
export function AuthBackground() {
  return (
    <div className="absolute inset-0 -z-10 overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/5 w-64 h-64 bg-primary/20 rounded-full mix-blend-multiply filter blur-2xl opacity-30 animate-float" style={{ animationDelay: "2s" }}></div>
      <div className="absolute top-1/2 left-1/2 w-80 h-80 bg-primary/10 rounded-full mix-blend-multiply filter blur-2xl opacity-30 animate-float" style={{ animationDelay: "4s" }}></div>
