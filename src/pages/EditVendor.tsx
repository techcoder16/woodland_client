  ...
  useEffect(() => {
    if (vendor) {
      const transformedVendorData = {
        ...
        fax: vendor.fax || "",
        email: vendor.email || "",
        webste: vendor.webste || "",  // Note: Fix potential typo in API response vs. form schema
        pager: vendor.pager || "",
        ...
        sales_fee: vendor.salesFee || "",
        management_fee: vendor.managementFee || "",
        finders_fee: vendor.findersFee || "",
        sales_fee_a: vendor.salesFeeA || "",
        management_fee_a: vendor.managementFeeA || "",
        finders_fee_a: vendor.findersFeeA || "",
        nrl_ref: vendor.nrlRef || "",
        nrl_rate: vendor.nrlRate || "",
        vat_number: vendor.vatNumber || "",
        landlord_full_name: vendor.landlordFullName || "",
        landlord_contact: vendor.landlordContact || "",
        comments: vendor.comments || "",
        other_info: vendor.otherInfo || "",
  
        bank_body: vendor.bankBody || "",
        bank_address_line_1: vendor.bankAddressLine1 || "",
        bank_address_line_2: vendor.bankAddressLine2 || "",
        bank_town: vendor.bankTown || "",
        bank_post_code: vendor.bankPostCode || "",
        bank_country: vendor.bankCountry || "",
        bank_iban: vendor.bankIban || "",
        bic: vendor.bic || "",
        nib: vendor.nib || "",
        ...
        attachments: vendor.attachments
          ? vendor.attachments.map((path: string) => new File([], path)) // Placeholder files
          : [],
      };
...
const handleNext = async () => {
  ...
  console.log(currentStepFields); // Debugging: Ensure correct fields are being validated
