          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <SelectField
                ...
                options={[
                  ...
                  {
                    value: "The-Deposit-Protection-Service",
                    label: "The Deposit Protection Service",
                  },
                  {
                    value: "Tenancy-Deposit-Solutions-Limited",
                    label: "Tenancy Deposit Solutions Limited",
                  },
                ]}
                setValue={setValue}
                onChange={value => {
                  handleSelectChange("HoldBy", value);
                }}
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <SelectField
                ...
                setValue={setValue}
                onChange={value => {
                  handleSelectChange("HowFurnished", value);
                }}
              />
            ...
            <div className="space-y-4 pt-6 border-t">
              <div className="flex items-center justify-between">
                ...
                <Button type="button" onClick={() => setIsDepositModalOpen(true)} className="">
                  Add Deposit
                </Button>
              </div>
                    ...
                    <TableBody>
                      {depositFields.map((field, index) => (
                        <TableRow key={field.id}>
                          ...
                          <TableCell>
                            £{field.rent} / £{field.bill}
                          </TableCell>
                          <TableCell>
                            {field.per} / {field.month} months
                          </TableCell>
                          <TableCell>
