...
const styles = StyleSheet.create({
  ...
  title: { textAlign: "center", fontSize: 12, fontFamily: "Helvetica-Bold", marginBottom: 20, letterSpacing: 0.5 },
  ...
  dear: { fontSize: 9, marginBottom: 14 },
  ...
  fieldLabel: { width: 80, fontSize: 9, fontFamily: "Helvetica-Bold" },
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        {/* Title */}
        <Text style={styles.title}>RENT REMINDER</Text>
        ...
        {/* Dear */}
        {tenantName ? <Text style={styles.dear}>Dear {tenantName}</Text> : null}
        ...
        <Text style={styles.body}>
          Following amount is outstanding from you as rent arrears. Please arrange to settle this within next seven days.
        </Text>
        ...
        {dueDateFmt ? (
          <View style={styles.fieldRow}>
            ...
            <Text style={styles.fieldValue}>{dueDateFmt}</Text>
          </View>
        ) : null}
...
export default RentReminderPDF;
